...
class Login extends React.Component {
  ...
  onFinish(values) {
    if (!this.state.isRegisterForm) {
      axios
        .post("https://shopper496.herokuapp.com/auth/customerLogin", {
      ...
      axios
        .post("https://shopper496.herokuapp.com/auth/customerRegister", {
          username: values.username,
          password: values.password,
      ...
      >
        ...
        >
          ...
          <Form.Item name="remember" valuePropName="checked">
            <Checkbox style={{ marginTop: 10, marginLeft: 0 }}>
              Remember me
            </Checkbox>
          </Form.Item>
            ...
            {!this.state.isRegisterForm ? (
              <div style={{ fontSize: 18 }}>
                ...
                <button
                  ...
                  onClick={() => this.setState({ isRegisterForm: true })}
                >
                  Register here.
                </button>
              </div>
              ...
              <div style={{ fontSize: 18 }}>
                ...
                <button
                  type="button"
                  className="link-button"
                  onClick={() => this.setState({ isRegisterForm: false })}
                >
                  Log in here.
                </button>
              </div>
